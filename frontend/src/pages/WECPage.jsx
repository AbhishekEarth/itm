    ...
    <div className="min-h-screen bg-[#fbf7f2] dark:bg-[#020617]">
      ...
      <section className="bg-white dark:bg-gray-900 border-y border-rose-100 dark:border-gray-800 py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {TEAM.map((m) => (
              <div key={m.name} className="relative overflow-hidden bg-white dark:bg-gray-900 border border-rose-50 dark:border-gray-800 rounded-3xl p-6 hover:shadow-xl transition-shadow text-center">
                <div className={`h-1.5 bg-gradient-to-r ${m.accent} -mx-6 -mt-6 mb-5`}></div>
                <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${m.accent} text-white flex items-center justify-center font-black text-sm mx-auto mb-3`}>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24">
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="text-3xl md:text-4xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white">Making an impact.</h2>
        </div>
        <div className="space-y-3">
          {EVENTS.map((e, i) => (
            <motion.div key={e.title} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.04 }}
              className="flex gap-4 p-5 bg-white dark:bg-gray-900 border border-rose-50 dark:border-gray-800 rounded-2xl hover:shadow-md transition-shadow">
              <div className="shrink-0 w-24 text-xs font-black text-[#800000] tracking-tight">{e.date}</div>
      ...
      <section className="bg-white dark:bg-gray-900 border-y border-rose-100 dark:border-gray-800 py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2 className="text-3xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white">WEC in action.</h2>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-20">
        <div className="rounded-3xl overflow-hidden bg-gradient-to-br from-[#1a0606] via-[#3e0202] to-[#800000] text-white p-8 md:p-12 grid md:grid-cols-2 gap-6 items-center">
          <div>
            ...
            <h3 className="text-3xl md:text-4xl font-black tracking-tighter mb-3">Together we rise.</h3>
            <p className="text-rose-100/80 text-sm font-medium max-w-md">Reach out to the Women Empowerment Cell for events, support and community activities.</p>
          </div>
