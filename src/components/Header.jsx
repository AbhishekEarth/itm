                          ...
                          >
                            <div className="ml-5 pl-3 border-l-2 border-red-200 dark:border-red-900/50 space-y-0.5 pb-1">
                              {[
                                ...
                                { name: 'Internet of Things', icon: '🌐', path: '/emerging-branches' },
                                { name: 'AI & Machine Learning', icon: '🤖', path: '/emerging-branches' },
                                { name: 'Cyber Security', icon: '🛡️', path: '/emerging-branches' },
                              ].map((sub) => (
                                <Link
                                  key={sub.name}
                                  to={sub.path}
