    ...
    <div className="min-h-screen bg-[#fbf7f2] dark:bg-[#020617]">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-20">
        <div className="grid md:grid-cols-2 gap-4">
          <div className="relative overflow-hidden bg-white dark:bg-gray-900 rounded-3xl border border-rose-50 dark:border-gray-800 shadow-sm p-8">
            ...
            <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed font-medium italic">&ldquo;Create an environment where sports and academics go hand in hand, ensuring the all-round development of students while preparing them for competitive sports.&rdquo;</p>
          </div>
          <div className="relative overflow-hidden bg-white dark:bg-gray-900 rounded-3xl border border-rose-50 dark:border-gray-800 shadow-sm p-8">
            ...
            <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed font-medium italic">&ldquo;Establish world-class sports infrastructure, enhance participation in inter-university tournaments, and support outstanding athletes with scholarships and specialised training.&rdquo;</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white dark:bg-gray-900 border-y border-rose-100 dark:border-gray-800 py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white">{SPORTS.length} sports on campus.</h2>
          </div>
          <div className="flex flex-wrap justify-center gap-3">
            {SPORTS.map((s, i) => (
              <motion.span key={s} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }}
                className="px-4 py-2 bg-rose-50 dark:bg-gray-800 text-[#800000] dark:text-rose-400 rounded-full font-black text-xs uppercase tracking-widest">
                {s}
              </motion.span>
            ))}
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24">
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="text-3xl md:text-4xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white">What we organise.</h2>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-20">
        ...
        <div className="max-w-xs mx-auto mb-6">
          <div className="relative overflow-hidden bg-gradient-to-br from-[#3e0202] to-[#800000] text-white rounded-3xl p-6 text-center shadow-xl">
            <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center font-black text-lg mx-auto mb-3">MK</div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {TEAM.map((m) => (
            <div key={m.name} className="relative overflow-hidden bg-white dark:bg-gray-900 border border-rose-50 dark:border-gray-800 rounded-2xl p-4 hover:shadow-md transition-shadow flex items-center gap-3">
              <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${m.accent} text-white flex items-center justify-center font-black text-xs shrink-0`}>
      ...
      <section className="bg-white dark:bg-gray-900 border-y border-rose-100 dark:border-gray-800 py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2 className="text-3xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white">Sports in action.</h2>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-20">
        <div className="rounded-3xl overflow-hidden bg-gradient-to-br from-[#1a0606] via-[#3e0202] to-[#800000] text-white p-8 md:p-12 grid md:grid-cols-2 gap-6 items-center">
          <div>
            ...
            <h3 className="text-3xl md:text-4xl font-black tracking-tighter mb-3">Play. Compete. Excel.</h3>
            <p className="text-rose-100/80 text-sm font-medium max-w-md">Connect with the Sports Cell to participate in tournaments, training sessions and national-level competitions.</p>
          </div>
          <div className="flex flex-col gap-3">
            <a href="mailto:sportsofficer@itmgoi.in" className="bg-amber-300 text-[#1a0606] text-center font-black text-xs tracking-widest px-6 py-4 rounded-2xl hover:scale-[1.02] transition-transform inline-flex items-center justify-center gap-2">
