      ...
      <div className="bg-gradient-to-r from-[#3e0202] via-[#6b0000] to-[#800000] text-white px-6 py-4">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-black text-sm">Faculty Portal</p>
      ...
      <div className="max-w-5xl mx-auto px-6 py-10 space-y-8">
          ...
          {INFO_CARDS.map((c, i) => {
            ...
            return (
              <motion.div key={c.label} variants={fadeUp} initial="hidden" animate="visible" custom={i * 0.5 + 1}
                ...
                <p className="font-black text-[#3e0202] text-sm leading-tight">{c.value}</p>
              </motion.div>
            );
          })}
        </div>
        ...
        {user.bio && (
          <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={3}
            ...
            <p className="text-[11px] font-black uppercase tracking-widest text-gray-400 mb-2">About</p>
