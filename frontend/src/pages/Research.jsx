        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-14 md:py-20 grid lg:grid-cols-12 gap-10 items-end">
          ...
          <div className="lg:col-span-5 grid grid-cols-2 gap-3">
            {[
              ...
              <motion.div key={s.l} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }} className="bg-white/10 backdrop-blur border border-white/20 rounded-2xl p-5">
            ...
            <Link to={q.path} key={q.title}>
              ...
              >
                ...
                <div className="relative">
                  <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${q.accent} flex items-center justify-center text-white shadow-lg mb-5`}>
                    <q.icon size={22} />
                  </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-20">
        <div className="rounded-3xl overflow-hidden bg-gradient-to-br from-[#3e0202] via-[#800000] to-[#5a0000] text-white p-8 md:p-12 grid md:grid-cols-2 gap-6 items-center">
          <div>
            ...
            <h3 className="text-3xl md:text-4xl font-black tracking-tighter mb-3">Research collaboration?</h3>
