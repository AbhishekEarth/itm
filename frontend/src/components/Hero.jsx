          ...
          >
            {hero.primary_cta && (
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="bg-gradient-to-r from-[#a30000] to-[#800000] text-white px-6 sm:px-9 py-3 sm:py-3.5 rounded-xl font-black text-[11px] tracking-widest uppercase shadow-xl shadow-[#800000]/40 dark:shadow-[0_0_15px_rgba(220,38,38,0.3)] cursor-pointer transition-all duration-300"
              >
            ...
            {hero.secondary_cta && (
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="group flex items-center gap-2 sm:gap-3 px-5 sm:px-7 py-3 sm:py-3.5 rounded-xl font-black text-[11px] tracking-widest uppercase border-2 border-white/30 bg-white/5 backdrop-blur-sm text-white cursor-pointer hover:bg-white/10 dark:hover:shadow-[0_0_20px_rgba(255,255,255,0.15)] transition-all duration-300"
              >
