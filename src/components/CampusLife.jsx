        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 min-h-[700px]">
          {campusHighlights.map((item, i) => (
            ...
            >
              ...
              {/* Deepened Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/100 via-black/60 to-transparent opacity-90 transition-opacity" />
              ...
              <div className="absolute bottom-8 left-8 right-8 z-20 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <p className="text-[#FFD700] text-[11px] font-black uppercase tracking-[0.2em] mb-1 drop-shadow-2xl">
                  {item.subtitle}
                </p>
                
                {/* TITLE */}
                <h3 className="text-white text-2xl md:text-3xl font-black tracking-tight drop-shadow-2xl">
                  {item.title}
                </h3>
