...
SYSTEM_PRESETS: list[PresetSpec] = [
    ...
    {
        "key": "dept_editor_aiml",
        "label": "Department Editor — AI & ML",
        "description": "Edit the AI & ML (emerging branch) department page.",
        "scope_keys": ["dept.aiml", "gallery", "seo.edit"],
    },
    {
        "key": "dept_editor_cyber",
        "label": "Department Editor — Cyber Security",
        "description": "Edit the Cyber Security (emerging branch) department page.",
        "scope_keys": ["dept.cyber", "gallery", "seo.edit"],
    },
    {
        "key": "dept_editor_cloud",
        "label": "Department Editor — Cloud Computing",
        "description": "Edit the Cloud Computing (emerging branch) department page.",
        "scope_keys": ["dept.cloud", "gallery", "seo.edit"],
    },
    {
        "key": "dept_editor_data",
        "label": "Department Editor — Data Science",
        "description": "Edit the CSE (Data Science) department page.",
        "scope_keys": ["dept.data", "gallery", "seo.edit"],
    },
    {
        "key": "dept_editor_mca",
        "label": "Department Editor — MCA",
        "description": "Edit the MCA programme page.",
        "scope_keys": ["dept.mca", "gallery", "seo.edit"],
    },
    {
        "key": "dept_editor_bba",
        "label": "Department Editor — BBA",
        "description": "Edit the BBA programme page.",
        "scope_keys": ["dept.bba", "gallery", "seo.edit"],
    },
    {
        "key": "dept_editor_bca",
        "label": "Department Editor — BCA",
        "description": "Edit the BCA programme page.",
        "scope_keys": ["dept.bca", "gallery", "seo.edit"],
    },
    {
        "key": "admissions_team",
