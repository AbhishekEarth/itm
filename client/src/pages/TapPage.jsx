...
const TapPage = () => {
  ...
  return (
    <div className="pb-16 bg-gray-50 min-h-screen">
      {/* Page Header */}
      <div className="relative w-full bg-gray-900 mb-12 shadow-xl overflow-hidden rounded-b-[3rem]">
        {/* Background Slider */}
        ...
        <div className="relative w-full px-8 md:px-16 py-8 md:py-12 z-10 text-white flex flex-col justify-end bg-gray-900">
          ...
          >
            Training and Placements (TAP)
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 }}
            className="text-gray-100 text-lg md:text-xl max-w-3xl drop-shadow-md"
          >
        ...
        <div className="min-h-[400px]">
          <AnimatePresence mode="popLayout" initial={false}>
            ...
            {activeTab === 'About TAP' && (
              ...
              >
                <section className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 flex flex-col justify-center">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="bg-blue-100 p-3 rounded-xl text-blue-600">
                      <Info className="w-6 h-6" />
                    </div>
                    <h2 className="text-2xl font-bold text-gray-900">About TAP</h2>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <section className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 flex-1 flex flex-col justify-center">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="bg-accent-100 p-3 rounded-xl text-accent-600">
                ...
                <section className="mt-4">
                  <div className="flex items-center gap-3 mb-6">
                     ...
                     <h2 className="text-3xl font-bold text-gray-900">Major Recruiters</h2>
                  </div>
                ...
                <section className="mt-4">
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-gray-900">Industry Speak About ITM Gwalior</h2>
                  </div>
                    ...
                    {industrySpeak.map((item, index) => (
                      ...
                      >
                         <div className="mb-4">
                          ...
                          <p className="text-xs font-semibold text-primary-600 uppercase tracking-wider">{item.role}</p>
                         </div>
                ...
                <section className="mt-4">
                  <div className="flex flex-col md:flex-row justify-between items-end mb-8">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        <Briefcase className="w-8 h-8 text-primary-600" />
                        <h2 className="text-3xl font-bold text-gray-900">Collaborations & MoUs</h2>
                      </div>
                      <p className="text-gray-600">Bridging the gap with industry leaders.</p>
                    </div>
                    <div className="mt-4 md:mt-0 px-4 py-2 bg-primary-50 rounded-lg border border-primary-100 text-primary-700 font-semibold text-sm flex items-center">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <motion.div 
                       whileHover={{ y: -5 }}
                       className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 flex flex-col items-center justify-center text-center gap-4"
                    >
            ...
            {activeTab === 'TAP Team' && (
              ...
              >
                <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100">
                  <div className="flex items-center justify-center gap-4 mb-10 border-b pb-6">
                    <h2 className="text-3xl font-bold text-gray-900">Meet the TAP Team</h2>
                  </div>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="flex flex-col items-center text-center bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:shadow-md transition-shadow">
                      <div className="w-32 h-32 rounded-full overflow-hidden shrink-0 border-4 border-white shadow-lg mb-6">
                        <img src="/images/Arpit_Singh.jpg" alt="Mr. Arpit Singh Chauhan" className="w-full h-full object-cover object-top" />
                      </div>
                      <div>
                        <h4 className="font-bold text-xl text-gray-900 mb-1">Mr. Arpit Singh Chauhan</h4>
                        <p className="text-sm text-primary-600 font-bold mb-4 bg-primary-50 py-1 px-3 rounded-full inline-block">(Dean/Director TAP CELL I/C)</p>
                        <p className="text-sm text-gray-600 mb-1">arpit.chauhan@itmuniversity.ac.in</p>
                        <p className="text-sm text-gray-600 font-medium">+91-9691973919</p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:shadow-md transition-shadow">
                      ...
                      <div>
                        <h4 className="font-bold text-xl text-gray-900 mb-1">Mrs. Shikha Sharma</h4>
                        <p className="text-sm text-primary-600 font-bold mb-4 bg-primary-50 py-1 px-3 rounded-full inline-block">(Asst. Director Placement)</p>
                        <p className="text-sm text-gray-600 mb-1">shikhasharma@itmuniversity.ac.in</p>
                        <p className="text-sm text-gray-600 font-medium">+91-9229333335</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {activeTab === 'Placement Records' && (
              ...
              >
                <div className="bg-primary-900 text-white rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-8 opacity-10">
                    <Award className="w-48 h-48" />
                  </div>
                  <h2 className="text-3xl font-bold mb-8 relative z-10 flex items-center gap-4">
                    <Award className="w-8 h-8 text-accent-500" />
                    Consistent Placement Records
                  </h2>
                  <div className="space-y-4 relative z-10">
                    {placementRecords.map((year, idx) => (
                      <div key={idx} className="flex justify-between items-center bg-primary-800/50 p-6 rounded-2xl hover:bg-primary-800 transition-colors border border-primary-700/50">
                        <span className="text-xl font-bold text-gray-100">{year}</span>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2">
                    <div className="p-8 md:p-12 flex flex-col justify-center">
                      <div className="flex items-center gap-3 mb-8">
                        ...
                        <h2 className="text-3xl font-bold text-gray-900">TAP Events</h2>
                      </div>
                      <ul className="space-y-8">
                        {tapEventsData.map((event, index) => (
                          <li key={index} className="flex gap-4 items-start bg-gray-50 p-4 rounded-xl border border-gray-100 hover:border-primary-200 transition-colors">
                            <CheckCircle2 className="w-6 h-6 text-accent-500 shrink-0 mt-1" />
                            <p className="text-gray-700 text-sm leading-relaxed">{event}</p>
                          </li>
                        ))}
                      </ul>
                    </div>
                    <div className="h-96 lg:h-auto overflow-hidden relative w-full min-h-[500px] bg-gray-50 border-l border-gray-100 flex items-center justify-center p-8">
                      <AnimatePresence mode="popLayout">
                        <motion.img 
