...
const SUBMISSION_STEPS = [
  ...
  { n: 2, title: "Submit via Portal", body: "Upload through iijisem.com submission system or email PDF." },
  { n: 3, title: "Peer Review", body: "Double-blind review — typically 4-6 weeks for first decision." },
  { n: 4, title: "Revise & Publish", body: "Incorporate reviewer feedback, then publish in upcoming issue." },
];
  ...
  return (
    <div className="min-h-screen bg-[#fbf7f2] dark:bg-[#020617]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#3e0202] via-[#800000] to-[#5a0000] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-14 md:py-20 grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            <a href="https://iijisem.com" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 bg-white text-[#800000] px-6 py-3 rounded-full font-black text-[11px] tracking-widest uppercase hover:scale-[1.02] transition-transform shadow-xl">
          ...
          <div className="lg:col-span-5">
            <motion.div initial={{ rotate: -3, opacity: 0 }} animate={{ rotate: 3, opacity: 1 }} transition={{ duration: 0.6 }} className="relative aspect-[3/4] max-w-sm mx-auto">
              ...
              <div className="relative bg-gradient-to-br from-[#1a0606] via-[#3e0202] to-[#800000] rounded-3xl h-full p-8 flex flex-col justify-between border-4 border-white shadow-2xl">
                <div>
                  <div className="text-[9px] uppercase tracking-[0.3em] font-black text-amber-300 mb-2">IIJISEM</div>
                  <h3 className="text-2xl font-black tracking-[-0.03em] leading-tight">ITM International Journal of Innovative Science, Engineering &amp; Management</h3>
                </div>
                <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-20">
        <a href="https://iijisem.com" target="_blank" rel="noreferrer"
          className="group block relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#1a0606] via-[#3e0202] to-[#800000] text-white p-8 md:p-12 hover:shadow-2xl transition-shadow">
          ...
          <div className="relative grid md:grid-cols-3 gap-6 items-center">
            <div className="md:col-span-2">
              ...
              <h3 className="text-2xl md:text-4xl font-black tracking-[-0.03em] mb-2">
