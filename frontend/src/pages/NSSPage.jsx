    ...
    <div className="min-h-screen bg-[#fbf7f2] dark:bg-[#020617]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#3e0202] via-[#800000] to-[#5a0000] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-14 md:py-20 grid lg:grid-cols-12 gap-6 sm:gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <p className="text-red-100/80 text-xs sm:text-base max-w-xl leading-relaxed font-medium italic">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-16 md:py-20">
        <div className="grid md:grid-cols-2 gap-3 sm:gap-4">
          <div className="relative overflow-hidden bg-white dark:bg-gray-900 rounded-3xl border border-rose-50 dark:border-gray-800 shadow-sm p-4 sm:p-8">
            ...
            <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-[#800000] to-[#5a0000] text-white flex items-center justify-center mb-3 sm:mb-5 text-xl sm:text-2xl">🎗️</div>
            <div className="text-[10px] font-black uppercase tracking-[0.3em] text-[#800000] mb-2">NSS Motto</div>
            <p className="text-xl sm:text-2xl font-black text-[#1a0606] dark:text-white italic mb-2 sm:mb-3">&ldquo;Not Me, But You&rdquo;</p>
            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium leading-relaxed">Reflecting the essence of democratic living and selfless service to society.</p>
          </div>
          <div className="relative overflow-hidden bg-white dark:bg-gray-900 rounded-3xl border border-rose-50 dark:border-gray-800 shadow-sm p-4 sm:p-8">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-amber-500 to-[#800000]"></div>
            <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-700 text-white flex items-center justify-center mb-3 sm:mb-5 text-xl sm:text-2xl">☸️</div>
            <div className="text-[10px] font-black uppercase tracking-[0.3em] text-amber-700 dark:text-amber-400 mb-2">NSS Logo</div>
            <p className="text-xs sm:text-sm text-gray-700 dark:text-gray-300 font-medium leading-relaxed">Based on the Rath Wheel of the Konark Sun Temple (Odisha) with 24 spokes representing 24 hours — symbolising energy, dynamism, and youth.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white dark:bg-gray-900 border-y border-rose-100 dark:border-gray-800 py-8 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-6 sm:mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white">Five core objectives.</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-3 max-w-4xl mx-auto">
            {OBJECTIVES.map((o, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }}
                className="flex items-start gap-3 p-3 sm:p-5 bg-rose-50/50 dark:bg-gray-800 rounded-2xl">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-16 md:py-24">
        <div className="text-center max-w-2xl mx-auto mb-6 sm:mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white">Service in action.</h2>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {ACTIVITIES.map((a, i) => (
            <motion.div key={a.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.04 }} whileHover={{ y: -4 }}
              className="bg-white dark:bg-gray-900 border border-rose-50 dark:border-gray-800 rounded-3xl p-3 sm:p-5 hover:shadow-xl transition-shadow">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-16 md:py-20">
        ...
        <div className="grid sm:grid-cols-2 gap-3 sm:gap-4 max-w-2xl mx-auto">
          {OFFICERS.map((o) => (
            <div key={o.name} className="relative overflow-hidden bg-white dark:bg-gray-900 border border-rose-50 dark:border-gray-800 rounded-3xl p-3 sm:p-6 hover:shadow-xl transition-shadow">
              <div className={`h-1.5 bg-gradient-to-r ${o.accent} -mx-3 sm:-mx-6 -mt-3 sm:-mt-6 mb-3 sm:mb-5`}></div>
              <div className={`w-9 h-9 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-br ${o.accent} text-white flex items-center justify-center font-black text-sm mb-2 sm:mb-3`}>
      ...
      <section className="bg-white dark:bg-gray-900 border-y border-rose-100 dark:border-gray-800 py-8 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-6 sm:mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white">NSS in action.</h2>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-16 md:py-20">
        <div className="rounded-3xl overflow-hidden bg-gradient-to-br from-[#1a0606] via-[#3e0202] to-[#800000] text-white p-5 sm:p-8 md:p-12 grid md:grid-cols-2 gap-4 sm:gap-6 items-center">
          <div>
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tighter mb-2 sm:mb-3">Serve. Lead. Grow.</h3>
            <p className="text-rose-100/80 text-xs sm:text-sm font-medium max-w-md">200 volunteers strong — join ITM&apos;s NSS Cell and make a real difference in your community.</p>
          </div>
