      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-16">
          ...
          <motion.h2
            ...
            className="text-3xl sm:text-4xl md:text-6xl font-black text-[#1a0606] dark:text-white mt-3 sm:mt-4 tracking-tighter"
          >
            ...
            <EditableText pageKey={pageKey} tkey="campuslife.title.line2" as="span" value="ITM Gwalior."
              className="text-transparent bg-clip-text bg-gradient-to-r from-[#800000] to-red-600 dark:from-rose-400 dark:to-amber-200">ITM Gwalior.</EditableText>
          </motion.h2>
        </div>
