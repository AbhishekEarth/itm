        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 sm:mb-12">
          <div className="max-w-xl">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white leading-[1.05]">
              <EditableText pageKey={pageKey} tkey="stats.title.line1" as="span" value="Built for student">
                Built for student
              </EditableText>{" "}
              <EditableText
                pageKey={pageKey}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
          {data.map((s, i) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="group relative overflow-hidden bg-white dark:bg-gray-900 rounded-3xl border border-rose-50 dark:border-gray-800 shadow-sm hover:shadow-2xl transition-shadow p-4 sm:p-5"
            >
              {/* Glow */}
              <div
