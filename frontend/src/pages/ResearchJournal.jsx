        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {VOLUMES.map((v) => (
            <a key={v.label} href="https://iijisem.com" target="_blank" rel="noreferrer"
              className={`group relative overflow-hidden rounded-3xl p-6 hover:shadow-2xl transition-shadow ${v.latest ? "bg-gradient-to-br from-[#3e0202] to-[#800000] text-white" : "bg-white dark:bg-gray-900 border border-rose-50 dark:border-gray-800"}`}>
      ...
      <section className="bg-white dark:bg-gray-900 border-y border-rose-100 dark:border-gray-800 py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="mb-8 max-w-xs mx-auto">
            <div className="bg-gradient-to-br from-[#3e0202] to-[#800000] text-white rounded-3xl p-6 text-center shadow-xl">
