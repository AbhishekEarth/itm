...
const departments = [
  {
    name: "CS Department",
    icon: "💻",
    desc: "Nurturing innovators with cutting-edge labs and an industry-led curriculum in Computer Science, AI, and Software Engineering.",
  ...
  },
  {
    name: "IT Department",
    icon: "🌐",
    desc: "Developing digital-first professionals through 565 hybrid terminals, cloud computing labs, and emerging-tech programs.",
  ...
  },
  {
    name: "EC Department",
    icon: "📡",
    desc: "Mastering electronics, communication and VLSI design with NBA accreditation and dedicated research & R&D labs since 1997.",
  ...
  },
  {
    ...
    icon: "📊",
    desc: "Developing global business leaders through case-study based learning and corporate mentorship programs.",
    accent: "from-[#800000] to-red-700",
    path: "#"
  },
  {
    ...
    icon: "⚖️",
    desc: "Promoting justice and excellence in legal education through moot courts and extensive research facilities.",
    accent: "from-[#800000] to-red-800",
    path: "#"
  },
  {
          ...
          {departments.map((dept, index) => (
            <Link to={dept.path} key={index}>
              <motion.div 
                ...
                whileHover={{ y: -10 }}
                className="group relative p-10 bg-gray-50 dark:bg-white/[0.03] rounded-[3rem] border-2 border-transparent hover:border-[#800000] transition-all duration-500 shadow-sm cursor-pointer"
              >
