        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-5 mb-10 sm:mb-20">
          {DISTINCTIVENESS.pillars.map((p, i) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group relative overflow-hidden bg-white dark:bg-gray-900 rounded-3xl border border-rose-50 dark:border-gray-800 shadow-sm hover:shadow-2xl hover:shadow-rose-950/5 dark:hover:shadow-rose-950/20 transition-all duration-300 ease-out p-3 sm:p-6"
            >
