...
const libPosterMaking = '/public/images/lib_poster_making.png';
const libGroupPhoto = '/public/images/lib_group_photo.png';
// ─── Data ────────────────────────────────────────────────────────────────────
const libraryStats = [
      ...
      <div className="relative bg-gradient-to-br from-[#3e0202] via-[#800000] to-[#5a0000] pt-16 pb-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white tracking-tighter mb-4 leading-tight">
            Akshardham<br />
            <span className="text-red-200">Central Library</span>
          </h1>
          <p className="text-red-100/80 max-w-xl text-sm leading-relaxed font-medium">
            Spanning 1200 sq. metres across three floors · Seating for 250 · 580 Mbps Wi-Fi · Open 9 AM – 9 PM Daily
          </p>

          {/* Quick-stat chips */}
          <div className="mt-8 flex flex-wrap gap-3">
            {[['📚', '64,407 Books'], ['📰', '1,785 Journals'], ['💻', '25 Systems'], ['🔬', 'Web of Science']].map(([icon, label]) => (
          ...
          <aside className="hidden lg:block lg:col-span-1">
            <div className="sticky top-32">
              <Card className="overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="font-black text-xs uppercase tracking-widest mb-4 text-[#800000]">LIBRARY MENU</h3>
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                {Object.entries(openAccess).map(([category, items]) => (
                  <Card key={category} className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {items.map((item) => (
                        <span key={item} className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-xs font-semibold px-3 py-1.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 hover:border-red-200 dark:hover:border-red-900 hover:text-[#800000] dark:hover:text-red-400 transition-all cursor-default">
                          {item}
                        </span>
                      ))}
                    </div>
