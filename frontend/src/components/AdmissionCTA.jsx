            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                <Link
                  ...
                  className="group inline-flex items-center gap-2 bg-white text-[#800000] px-4 py-2.5 sm:px-6 sm:py-4 rounded-full font-black text-[10px] sm:text-[11px] tracking-[0.2em] uppercase shadow-2xl hover:shadow-amber-400/30 dark:shadow-[0_0_15px_rgba(255,255,255,0.12)] dark:hover:shadow-[0_0_25px_rgba(255,255,255,0.28)] hover:scale-[1.02] transition-all"
                >
                  Apply Now
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 bg-black/30 backdrop-blur text-white border border-white/30 px-4 py-2.5 sm:px-6 sm:py-4 rounded-full font-black text-[10px] sm:text-[11px] tracking-[0.2em] uppercase hover:bg-black/50 dark:hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all"
                >
                  <CreditCard size={14} /> Pay Online
                </a>
                <a
                  href="tel:+917773005065"
                  className="inline-flex items-center gap-2 bg-white/10 backdrop-blur text-white border border-white/20 px-4 py-2.5 sm:px-6 sm:py-4 rounded-full font-black text-[10px] sm:text-[11px] tracking-[0.2em] uppercase hover:bg-white/20 dark:hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all"
                >
