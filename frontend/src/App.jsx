    ...
    <div className="bg-white dark:bg-[#020617] min-h-screen transition-colors duration-500">
      ...
      <div className={!isAdminArea && !isHome && !embedded ? 'pt-[96px] sm:pt-[128px] lg:pt-[140px]' : ''}>
        <Routes>
          ...
          {/* DYNAMIC PAGES — anything an admin creates via /admin/pages/visual
              falls through here and renders from the `pages` table. Must be
              the LAST route so it doesn't shadow the hard-coded ones above. */}
