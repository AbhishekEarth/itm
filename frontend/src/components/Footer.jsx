...
const SECTIONS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "CSE - Emerging Branches", to: "/emerging-branches" },
...
const SOCIALS = [
  ...
  { Icon: FaYoutube, url: "https://www.youtube.com/@itmgwalior", label: "YouTube" },
];
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="pt-5 sm:pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex flex-wrap justify-center gap-x-4 sm:gap-x-6 gap-y-1.5 sm:gap-y-2 text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-gray-500">
            <Link to="/about/policies" className="hover:text-amber-300 transition-colors">Privacy Policy</Link>
            <Link to="/about/policies" className="hover:text-amber-300 transition-colors">Terms of Use</Link>
            <Link to="/contact" className="hover:text-amber-300 transition-colors">Sitemap</Link>
