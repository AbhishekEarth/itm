...
class AdminPageCreate(BaseModel):
    """Body for POST /api/admin/pages — create a brand-new page row."""

    key: str = Field(..., min_length=1, max_length=64,
                     description="Stable identifier, e.g. 'student-life'")
    path: str = Field(..., min_length=1, max_length=255,
                      description="Public URL, e.g. '/student-life'")
