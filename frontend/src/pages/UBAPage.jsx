    ...
    <div className="min-h-screen bg-[#fbf7f2] dark:bg-[#020617]">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {VILLAGES.map((v, i) => (
            <motion.div key={v} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.07 }}
              className="flex items-center gap-2 px-5 py-3 bg-white dark:bg-gray-900 border border-rose-50 dark:border-gray-800 rounded-2xl shadow-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white mb-6">What we set out to do.</h2>
              <div className="space-y-3">
                {OBJECTIVES.map((o, i) => (
                  <motion.div key={i} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }}
                    className="flex items-start gap-3 p-4 bg-rose-50/50 dark:bg-gray-800 rounded-2xl">
            ...
            <div className="space-y-4">
              <div className="relative overflow-hidden bg-gradient-to-br from-[#3e0202] to-[#800000] text-white rounded-3xl p-8">
                <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center mb-4"><Compass size={20} /></div>
                <div className="text-[10px] uppercase tracking-widest font-black text-amber-300 mb-2">Program Description</div>
                <p className="text-sm leading-relaxed font-medium text-rose-100/90">Flagship program initiated by the Ministry of Education, Government of India, aimed at connecting higher educational institutions with rural communities to address developmental challenges.</p>
              </div>
              <div className="bg-amber-50 dark:bg-gray-800 border border-amber-100 dark:border-gray-700 rounded-3xl p-6">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24">
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="text-3xl md:text-4xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white">Impact on the ground.</h2>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {ACTIVITIES.map((a, i) => (
            <motion.div key={a.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} whileHover={{ y: -4 }}
              ...
              <h4 className="font-black text-base text-[#1a0606] dark:text-white tracking-tight mb-2">{a.title}</h4>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-20">
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="text-3xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white">Our team.</h2>
        </div>
        <div className="grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
          {TEAM.map((m) => (
            <div key={m.name} className="relative overflow-hidden bg-white dark:bg-gray-900 border border-rose-50 dark:border-gray-800 rounded-3xl p-6 hover:shadow-xl transition-shadow">
              <div className={`h-1.5 bg-gradient-to-r ${m.accent} -mx-6 -mt-6 mb-5`}></div>
              <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${m.accent} text-white flex items-center justify-center font-black text-sm mb-3`}>
      ...
      <section className="bg-white dark:bg-gray-900 border-y border-rose-100 dark:border-gray-800 py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2 className="text-3xl font-black tracking-[-0.03em] text-[#1a0606] dark:text-white">UBA in action.</h2>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-20">
        <div className="rounded-3xl overflow-hidden bg-gradient-to-br from-[#1a0606] via-[#3e0202] to-[#800000] text-white p-8 md:p-12 grid md:grid-cols-2 gap-6 items-center">
          <div>
            ...
            <h3 className="text-3xl md:text-4xl font-black tracking-tighter mb-3">Be part of the change.</h3>
            <p className="text-rose-100/80 text-sm font-medium max-w-md">Connect with the UBA Cell to participate in village visits, surveys and community development activities.</p>
          </div>
          <div className="flex flex-col gap-3">
            <a href="mailto:uba@itmgoi.in" className="bg-amber-300 text-[#1a0606] text-center font-black text-xs tracking-widest px-6 py-4 rounded-2xl hover:scale-[1.02] transition-transform inline-flex items-center justify-center gap-2">
              <Mail size={13} /> uba@itmgoi.in
            </a>
            <a href="tel:+918109707108" className="bg-black/30 backdrop-blur text-white border border-white/30 text-center font-black text-xs tracking-widest px-6 py-4 rounded-2xl hover:bg-black/50 transition-colors inline-flex items-center justify-center gap-2">
